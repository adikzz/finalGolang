...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "4459d311c38754", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "66a584466bf233", "SMTP password")
